...
namespace FinancesTracker.Controllers
{
    public class IncomesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IncomeId,Amount,Source,DateReceived")] Income income)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IncomeId,Amount,Source,DateReceived")] Income income)
        {
